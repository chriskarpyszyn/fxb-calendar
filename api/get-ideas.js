// API route to retrieve all submitted ideas from Redis
// Returns ideas as JSON array for frontend consumption

const { createClient } = require('redis');

// Helper function to get Redis client (same as submit-idea.js)
